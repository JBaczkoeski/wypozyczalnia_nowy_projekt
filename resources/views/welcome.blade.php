    ...
    <div class="container text-center">
        <div class="row">
            ...
            <div class="container shadow mb-5 py-3">
                ...
                <div class="container">
                    <form method="get" class="col-12 container">
                        <div class="row">
                            ...
                            <div class="container col-12 col-lg-1 pt-3">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="container col-lg-3 col-6">
                        <hr class="my-4" style="border-top: 3px solid;">
                        <p class="h3">Szybkość dostarczania samochodów</p>
